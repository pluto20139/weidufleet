...
const Dashboard: React.FC = () => {
  ...
  const ranking = useMemo(() => getAlertRanking(), []);

  const chartData = useMemo(
    () => ({
      labels: [t('dash.accl'), t('dash.decel'), t('dash.turn'), t('dash.fatigue'), t('dash.aeb')],
      datasets: [
        {
          label: t('dash.alerts'),
          data: riskTab === 'today' ? [12, 18, 8, 5, 9] : riskTab === '7d' ? [68, 95, 42, 28, 51] : [210, 285, 130, 88, 165],
          backgroundColor: ['#2563eb', '#059669', '#d97706', '#dc2626', '#8b5cf6'],
          borderRadius: 4,
          maxBarThickness: 40,
        },
      ],
