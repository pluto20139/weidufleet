        ...
        children: [
          {
            ...
            key: 'santiago',
            children: [{ title: 'Valparaiso', key: 'valparaiso' }],
          },
        ],
      },
    ],
...
const Biz: React.FC = () => {
  ...
  // Assets state
  const [assets, setAssets] = useState<AssetItem[]>(allAssets);
  ...
  const handleAssetSearch = () => {
    ...
    if (tenantAssetFilter) {
      filtered = filtered.filter((a) => a.tenant === tenantAssetFilter);
    }
    setAssets(filtered);
  };
