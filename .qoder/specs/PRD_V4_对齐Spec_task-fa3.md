...
**项目路径**: `weidu-fleet/`
**基线版本**: 当前 main 分支代码（含 V1.0/V1.1/V1.2 三版本功能）
...
### Task 1: 将 Spec 写入项目目录
将本文档保存为 `weidu-fleet/Spec_PRD_V4.md`，供团队查阅

### Task 2: 实施 P0 - C04 电池筛选Bug修复
修复 Risk.tsx 电池筛选下拉 value 与数据层 key 不一致的问题

### Task 3: 实施 P1 - 类型系统扩展
修改 `src/types/index.ts`，完成所有类型扩展（C03/C04/C05/C06/C07/C10）

### Task 4: 实施 P1 - Mock数据更新
修改 `src/api/mock.ts`，更新所有 Mock 数据以匹配新类型

### Task 5: 实施 P1 - 页面适配
逐一修改 Dashboard/Risk/Driving/Repair/Battery 页面

### Task 6: 实施 P2 - 全局及辅助变更
C01语言/C08轨迹/C09多选/C11审计/C12文案/i18n词条
